...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    title: `${author.metadata.name} | CYBER_MARKET Blog`,
    ...
    <div className="py-12 px-4 min-h-[60vh]">
      <div className="max-w-6xl mx-auto">
        ...
        <nav className="mb-8 flex items-center gap-2 text-sm font-display">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-neon-magenta">{author.metadata.name.toUpperCase()}</span>
        </nav>
        ...
        <div className="cyber-card rounded-xl p-8 mb-12">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            {author.metadata.avatar ? (
              ...
              <div className="w-32 h-32 rounded-full bg-neon-magenta/10 border-4 border-neon-magenta/30 flex items-center justify-center text-neon-magenta text-4xl font-display font-bold">
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="font-display text-2xl text-white mb-4">NO_POSTS_YET</h2>
