...
export default function CosmicBadge({ bucketSlug }: CosmicBadgeProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 flex items-center gap-2 text-gray-800 text-sm font-medium no-underline transition-colors duration-200 z-50 bg-white border border-gray-200 rounded-lg shadow-lg px-4 py-3 hover:bg-gray-50"
      style={{
        position: 'fixed',
        width: '180px',
      }}
